...
using QuanLyDaoTao.Web.Models.ThoiKhoaBieu;
using System;
...
namespace QuanLyDaoTao.Web.Controllers
{
    public class ThoiKhoaBieuController : Controller
    {
        ...
        public JsonResult DanhSach(Guid? ID)
        {
            ...
            string url = $"{Common.Common.ApiUrl}/ThoiKhoaBieu?ID={ID}";
            ...
            return Json(new { code = 200, msg = "Success", thoikhoabieu = danhsach });
        }
    }
}
