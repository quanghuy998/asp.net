...
using QuanLyDaoTao.Web.Models.KhungCT;
using System;
...
{
    public class KhungCTController : Controller
    {
        ...
        public JsonResult DanhSach(Guid? ID)
        {
            ...
            string url = $"{Common.Common.ApiUrl}/KhungCT?ID={ID}";
            ...
            return Json(new { code = 200, msg = "Success", khungct = danhsach });
        }
    }
}
