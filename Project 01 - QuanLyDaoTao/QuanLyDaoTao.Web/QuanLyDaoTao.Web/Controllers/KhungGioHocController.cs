...
using QuanLyDaoTao.Web.Models.KhungGioHoc;
using System;
...
{
    public class KhungGioHocController : Controller
    {
        ...
        public JsonResult DanhSach(Guid? ID)
        {
            ...
            string url = $"{Common.Common.ApiUrl}/KhungGioHoc?ID={ID}";
            ...
            return Json(new { code = 200, msg = "Success", khunggiohoc = danhsach });
        }
    }
}
