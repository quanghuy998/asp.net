...
using QuanLyDaoTao.Web.Models.BoTriPH;
using System;
...
{
    public class BoTriPHController : Controller
    {
        ...
        public JsonResult DanhSach(Guid? ID)
        {
            ...
            string url = $"{Common.Common.ApiUrl}/BoTriPH?ID={ID}";
            ...
            return Json(new { code = 200, msg = "Success", botriph = danhsach });
        }
    }
}
