...
using QuanLyDaoTao.Web.Models.ThiCu;
using System;
...
{
    public class ThiCuController : Controller
    {
        ...
        public JsonResult DanhSach(Guid? ID)
        {
            ...
            string url = $"{Common.Common.ApiUrl}/ThiCu?ID={ID}";
            ...
            return Json(new { code = 200, msg = "Success", thicu = danhsach });
        }
    }
}
